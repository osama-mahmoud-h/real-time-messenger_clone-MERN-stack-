...
import UserImageAvatar from './userNameAvatar';
            ...
            <div className='message-show'>
                        ...
                        m.senderId === myInfo.id ? <div key={index} ref={scrollRef} className="my-message">
                            <div className="image-message">
                                <div className="my-text">
                                    <p className='message-text my'>{m.message.text === '' ? <img src={`./uploads/sentImages/${m.message.image}`} alt='image' /> : m.message.text}</p>
                                    {/*
                ...
                */}
                            ...
                            <div className="image-message-time">
                                {/* <UserImageAvatar userName={currentfriend.userName}/> */}
                                {/* <img src={`./uploads/images/${currentfriend.image}`} alt="" /> */}
                                <div className="initials-placeholder">{currentfriend.userName.substring(0, 2).toUpperCase()}</div>
                                
                                <div className="message-time">
                                    <div className="fd-text">
                                        <p className='message-text fd'>{m.message.text === '' ? <img src={`./uploads/sentImages/${m.message.image}`} alt='image' /> : m.message.text}</p>
                                    </div>
                                    <div className="time">
                                    {moment(m.createdAt).startOf('mini').fromNow()}
                                    </div>
